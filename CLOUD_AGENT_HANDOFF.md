...
> **⚠️ READ PROJECT_STATUS FIRST** — Live bot identity, watchdog/auto-restart state, and day-to-day blockers are owned by `/Users/dubski/Projects/hyperliquid-condor-mm/docs/PROJECT_STATUS.md` (repo: `hyperliquid-condor-mm`, path `docs/PROJECT_STATUS.md`). This file is engineering history: the 2026-07-28 section below documents the P1/P2 edge-iteration work (written by a cloud agent with **no VPS access** — its VPS assumptions may be stale), and everything from the 2026-07-07 section down is historical (Jul 7 bot retired). Current live bot per PROJECT_STATUS: **`hl-testnet-pmm-20260724-191456-20260724-191456`** (the "Jul 24 bot"). **Verify live identity in `PROJECT_STATUS.md` before running any command from this document.**
